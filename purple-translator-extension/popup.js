...
기본 원칙: 외래어 표기는 2025년 국립국어원 외래어 표기법을 따르고, 표기 일관성을 유지한다.

| 계열             | 어두            | 어중/어말         |
| -------------- | ------------- | ------------- |
| カ행 (카 키 쿠 케 코) | 가, 기, 구, 게, 고 | 카, 키, 쿠, 케, 코 |
| タ행 (タ チ ツ テ ト) | 다, 지, 쓰, 데, 도 | 타, 치, 쓰, 테, 토 |
| キャ・キュ・キョ       | 갸, 규, 교       | 캬, 큐, 쿄       |
| チャ・チュ・チョ       | 자, 주, 조       | 차, 추, 초       |

2025년 국립국어원 표기법 기준,
위에서 설명한 **4개 계열(카행, 타행, 캬/규/교, 차/추/초)**을 제외한 나머지 일본어 가나 음절은, 단어의 위치(어두/어중/어말)에 관계없이 항상 동일한 표기를 따른다.
예시) ジャ → 자, ジュ → 주, ジョ → 조
(어두든 어말이든 항상 같음)
